...
const FormBusinessTrip = () => {
  ...
  if (isInclude) {
    if (_deptEmpList && _deptEmpList.length > 0) {
      const _searchResult = _deptEmpList.filter((item) =>
          ...
          <Card className="border-white shadow-lg bg-background/10 backdrop-blur-sm">
            <CardContent className="p-0">
              ...
              <div className="flex border-b bg-background/40 backdrop-blur-sm">
                ...
                >
                  {t("business_trip_registration_tab") || "Business Trip Registration"}
                </button>
                <button
              ...
              <div className="p-3 sm:p-4 md:p-6 lg:p-8 space-y-4 sm:space-y-6">
                ...
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <CardTitle className="text-xl sm:text-2xl md:text-3xl font-extrabold text-primary" id="title_text">
                    {activeTab === 'booking' ? (
                      <>
                        {t("register")} <span>{t("business")}</span>
                      </>
                    ) : (
