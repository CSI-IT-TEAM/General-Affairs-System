...
const uploadMedicalFormData = async (data) => {
  ...
  _formData.append("ARG_BIRTHDAY", data.BIRTHDATE);
  _formData.append("ARG_PASSPORT", data.PASSPORT);
  _formData.append("ARG_RELATIONSHIP", data.RELATIONSHIP);
  _formData.append("ARG_SERVICE_TYPE", data.SERVICE_TYPE);
  _formData.append("ARG_SERVICE_NAME", data.SERVICE_NAME);
  _formData.append("ARG_MEDICAL_CD", data.MEDICAL_CD);
  _formData.append("ARG_MEDICAL_NAME", data.MEDICAL_NAME);
  ...
  _formData.append("ARG_REMARKS", data.REMARKS);
