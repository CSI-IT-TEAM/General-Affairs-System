...
/**
 * @param {Object} props
 * @param {Date} [props.selectedMonth]
 * @param {(date: Date) => void} [props.onMonthSelect]
 * @param {() => void} [props.onYearForward]
 * @param {() => void} [props.onYearBackward]
 * @param {Object} [props.callbacks]
 * @param {function(number): string} [props.callbacks.yearLabel]
 * @param {function(Object): string} [props.callbacks.monthLabel]
 * @param {Object} [props.variant]
 * @param {Object} [props.variant.calendar]
 * @param {string} [props.variant.calendar.main]
 * @param {string} [props.variant.calendar.selected]
 * @param {string} [props.variant.chevrons]
 * @param {Date} [props.minDate]
 * @param {Date} [props.maxDate]
 * @param {Date[]} [props.disabledDates]
 */
